...
# This section contains utility functions for loading and processing employee data from an Excel file provided by TG HOD officers. The data is cleaned and structured into a dictionary for easy access throughout the application.
